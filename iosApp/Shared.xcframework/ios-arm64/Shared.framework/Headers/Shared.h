...
@property (readonly) SharedKotlinUnit *(^(^uiStateFlow)(SharedKotlinUnit *(^)(SharedDetailsUiState *, SharedKotlinUnit *(^)(void), SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError * _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void) __attribute__((swift_name("uiStateFlow")));
@property (readonly) SharedDetailsUiState *uiState __attribute__((swift_name("uiState")));
@end
...
@property (readonly) SharedCommonFlow<NSString *> *queryCommon __attribute__((swift_name("queryCommon")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> uiState __attribute__((swift_name("uiState")));
@property (readonly) SharedCommonFlow<SharedSearchUiState *> *uiStateCommon __attribute__((swift_name("uiStateCommon")));
@end
